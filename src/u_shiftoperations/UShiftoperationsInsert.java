...
public class UShiftoperationsInsert {
    ...
    private static void write(String text) {
        String fileName = "C:\\Windows\\Temp\\UShiftoperationsInsert.log";
            ...
            if (!"".equals(sOperation_id) && !"".equals(sShiftorder_id))
            {
                ...
                for (Map<String, String> rData: retData)
                {
                    if (!"".equals(rData.get("MESOrder")) && !"".equals(rData.get("Workplace")))
                    {
                        ...
                        {
                            if (debugPrint) write("RET=" + retVal.getReturnCode() + " KT= " + retVal.getShortText() + " LT= " + retVal.getLongText());
                        }
                        else
                        {   
                            if (debugPrint) write("RET=" + retVal.getReturnCode() + " OP " + rData.get("MESOrder") + " Finished");
                        }
                    }
                    ...
                    {
                        if (debugPrint) write("RET=" + retVal.getReturnCode() + "  " + rData.get("auftrag_nr") + " update op status");
                    }
                }
