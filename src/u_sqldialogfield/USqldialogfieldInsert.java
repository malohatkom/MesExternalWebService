 ...
 */
public class USqldialogfieldInsert {
    ...
    public void sdiAfterInit(IUserExitParam param) {
        ...
        for (String key: specialParameters.keySet()) write("USqldialogfieldInsert", key + " = " + (specialParameters.get(key).getValue() != null ? specialParameters.get(key).getValue().toString() : "null"));
