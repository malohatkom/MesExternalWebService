...
public class U_ShiftOperationsAssignWP implements ISimpleExternalService 
{
    ...
    public SesResult execute(SesRequest request, SesContext context, ISystemUtilFactory factory) {
        ...
        this.logger = loggerProvider.fetchLogger(U_ShiftOperationsAssignWP.class);
        ...
        SpecialParam resource_id = request.getSpecialParam("resource.id");
        ...
        if (operation_id != null && shiftorder_id != null && resource_id != null && shiftoperations_key != null)
        {
            this.logger.debug("U_ShiftOperationsAssignWP has params");
            ...
            try {
                ...
                String sql = 
                    ...
                    " Set " +
                    "   [masch_nr] = '" + resource_id.getValue().toString() + "', " +
                ...
                /*
                29.3 Plan operation (ANR.EINPLANEN)
                Plan operation for a workplace.
                Tables
                Table Key field Description
                auftrags_bestand ANR.ANR PK Combined order/OP number
                BAPI call
                ID Content/{type} Description
                DLG ANR.EINPLANEN Schedule operation
                ANR.ATYP {C4} Order type {OP}
