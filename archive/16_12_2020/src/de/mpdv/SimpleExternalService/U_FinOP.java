...
public class U_FinOP implements ISimpleExternalService {
	...
	builder.addCol("operation.act.status.led", DataType.STRING);
        ...
        ArrayList<String> SelWorkplaceList = new ArrayList();
        String strSelWorkplace;
        if (u_selWorkplace != null)
        {
            SelWorkplaceList.addAll((Collection)u_selWorkplace.getValue()); 
        ...
        switch (DataType)
        {
            ...
            default:
                ...
                Statement stmt = null;
                ResultSet rs = null;
                String sql = "SELECT * FROM [hydra1].[hydadm].[finishedOperationsData] ('" + strSelStartDate + "','" + strSelEndDate + "','" + strSelWorkplace + "' , '" + strDataType + "')";
